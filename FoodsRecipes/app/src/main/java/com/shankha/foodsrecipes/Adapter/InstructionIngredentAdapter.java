...
public class InstructionIngredentAdapter extends RecyclerView.Adapter<InstructionIngredentViewHolder> {
    Context context;
    List<Ingredient> list;

    public InstructionIngredentAdapter(Context context, List<Ingredient> list) {
    ...
    @NonNull
    @Override
    public InstructionIngredentViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new InstructionIngredentViewHolder(LayoutInflater.from(context).inflate(R.layout.list_instruction_step_item,parent,false));
    }

    @Override
    public void onBindViewHolder(@NonNull InstructionIngredentViewHolder holder, int position) {
...
class InstructionIngredentViewHolder extends RecyclerView.ViewHolder{
    TextView txtView_instruction_step_item;
    ImageView imageView_instruction_step_item;
    public InstructionIngredentViewHolder(@NonNull View itemView) {
        super(itemView);
